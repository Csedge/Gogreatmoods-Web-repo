...
<div id="container">
      ...
      <div id="content" style="height:600px">
        ...
        <h3></h3>
		<div class="table">
		 <form class="" action="addRep.php" method="POST" enctype="multipart/form-data" id="myForm" name="myForm" onsubmit="return(validate());">
              				<div class="tablerow">
              				...
              				<div class="tablerow">
              					<select name="vpid" onchange="fetch_select(this.value);" class="role2">
              					...
              					<select id="new_select" name="scid" class="role2">
              					</select>
              				</div> <!-- end row -->
              	<br>
              <ul class="tab-list clearfloat">
                <li class="tab-item">
                    ...
                    <label class="tab-label" for="testTabRadio1">Information</label>
                    <div class="tab-box">
                    <div ><h2 style="color:red">Contact Information</h2></div>
        						...
        						<div style="width:100%">
        						<div class="half_container" style="float:left">
                                   <div class="tablerow row-half"> <!-- title -->
        										<span id="hd_address1">Address 1</span>
        									</div> <!-- end row -->
        									<div class="tablerow row-half"> <!-- input -->
        									...
        									<div class="tablerow row-half"> <!-- titles -->
        									...
        									<div class="tablerow row-half" > <!-- inputs -->
        						  ...
        						  <div class="half_container" style="float:right">
        									<div class="tablerow row-half">
        						...
        						<div class="tablerow row-half">
        							<input id="wphone1" type="text" name="wphone" style="width:112px;margin:0 0.2em 0 0;"><!--<input id="wphone2" type="text" name=""><input id="wphone3" type="text" name="">-->
                ...
                <li class="tab-item">
                    ...
                    <label class="tab-label" for="testTabRadio2">Account Login</label>
                    <div class="tab-box">
                    <div ><h2 style="color:red">Create Your Account Login</h2></div>
                ...
                <li class="tab-item">
                    ...
                    <label class="tab-label" for="testTabRadio3">Payment</label>
                    <div class="tab-box">
               						<div><h2 style="color:red">3 Simple Steps for Payment</h2></div>
               						<h3 style="color:black">1. PayPal Information</h3>
               						...
               						<br>
               						<h3 style="color:black">2. Fund Distribution and Tax Information</h3>
               						...
               						<div class="tablerow">
               							<input id="ssn1" type="text" name="ssn1" style="width:30px;margin:0 0.2em 0 0;"><input id="ssn2" type="text" name="ssn2" style="width:20px;margin:0 0.2em 0 0;"><input id="ssn3" type="text" name="ssn3" style="width:40px;margin:0 0.8em 0 0;">
               							<input id="ftin1" type="text" name="ftin1" style="width:30px;margin:0 0.2em 0 0;"><input id="ftin2" type="text" name="ftin2" style="width:70px;margin:0 0.2em 0 0;">
               							<input id="stin1" type="text" name="stin1" style="width:30px;margin:0 0.2em 0 0;"><input id="stin2" type="text" name="stin2" style="width:70px;margin:0 0.2em 0 0;">
               							<input id="nonp1" type="text" name="nonp1" style="width:30px;margin:0 0.2em 0 0;"><input id="nonp2" type="text" name="nonp2" style="width:70px;margin:0 0.2em 0 0;">
               						</div>
               						<br>
               						<h3 style="color:black">3. 1099 Form</h3>
               						...
               						<br>
               						<h3 style="color:black">Sales Coordinator Total Commission Override: 1%</h3>
                    </div>
                </li>
                <li class="tab-item">
                    <input type="radio" id="testTabRadio4" class="test-radio" name="tab">
                    <label class="tab-label" for="testTabRadio4">SocialMedia</label>
                    <div class="tab-box">
                        <div ><h2>Social Media Connections</h2></div>
                        	<div class="tablerow">
                ...
                <li class="tab-item">
                    ...
                    <label class="tab-label" for="testTabRadio5">Profile Photo</label>
                    <div class="tab-box">
                        <div><h2 style="">Profile Photo</h2></div>
                        	<div class="tablerow">
            ...
            <input type="submit" name="submit" class="redbutton" style="margin-top:-50px;margin-left:5px" value="Save &amp; Exit">
            <input type="submit" name="submit" class="redbutton" style="margin-top:-50px;margin-left:5px" value="Save &amp; Add another">
           </form>
	</div> <!-- end table -->
     <br>
